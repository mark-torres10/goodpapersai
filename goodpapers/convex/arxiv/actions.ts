 ...
 *
 * Actions for fetching papers from ArXiv, downloading PDFs,
 * and storing them in Convex Storage.
 *
...
export const addPaperFromArxiv = action({
  ...
  handler: async (ctx, args) => {
    ...
    // Step 2: Check for duplicate (if papers schema exists)
    try {
...
/**
 * Helper function to access generated API (imported at runtime)
 */
function api() {
  return require("../_generated/api");
}